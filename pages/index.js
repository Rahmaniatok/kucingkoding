  ...
  return(
    <main className="flex flex-col jarak">
      ...
      <Head>
        ...
        <div className="flex  justify-center items-center h-1/4 min-h-screen">
        ...
        <div className="jarak h-1/4  min-h-screen">
          <div>
        ...
        <div classname="h-1/4  min-h-screen ">
          <h1 className="text-right">
          Bergabunglah dengan komunitas kami! 
          </h1>
          <div className="flex flex-col items-center rounded-lg bg-white opacity-50 mx-20 my-20">
            <Image 
              className="relative"
              src="/WA.svg"
              alt="WA logo"
